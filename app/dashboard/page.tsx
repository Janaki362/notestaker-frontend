    ...
    const fetchHistory = async () => {
      ...
      try {
        const res = await fetch(
          "https://notestaker-backend-194267172594.us-central1.run.app/history",
          {
            method: "GET",
            headers: {
      ...
      <section style={mainStyle}>
        <div style={{ marginBottom: "36px" }}>
          ...
          <p style={subtitleStyle}>
            Here is an overview of your recent AI study workspaces.
          </p>
        ...
        {loading ? (
          ...
          <div style={emptyStateStyle}>
            ...
            <p style={emptyTextStyle}>
              Upload your first file to generate AI notes, flashcards, and
              quizzes.
            </p>
                  ...
                  <div style={documentCardStyle}>
                    <div style={cardTopStyle}>
                      ...
                      <span
                        style={{
                          ...modeBadgeStyle,
                          backgroundColor: modeColor.backgroundColor,
